...
<img alt="Информация о персонаже" style="border-width:0;width:200px" src="./docs/design-flow/info_3.jpg" /> . <img alt="Информация об армиях" style="border-width:0;width:200px" src="./docs/design-flow/info_4.jpg" /> . <img alt="Вещи" style="border-width:0;width:200px" src="./docs/design-flow/info_5.jpg" /> .
